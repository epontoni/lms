...
export async function PATCH(
  ...
  try {
    ...
    // isPublished tendrá su propio endpoint
    ...
    if (chapterUpdated) return NextResponse.json(chapterUpdated);
  } catch (error) {
...
export async function DELETE(
  ...
  try {
    ...
    // Debe existir al menos un chapter para que el curso esté publicado
    ...
    if (deletedChapter) return NextResponse.json(deletedChapter);
  } catch (error) {
